     ...
     <main className='m-10 rounded-xl flex flex-col gap-4'>
      <div className='p-10 flex flex-col gap-6 bg-white rounded-md'>
       ...
       <div className='flex justify-between items-center'>
        <p>Bonus Statics</p>
       <p className='flex gap-3 items-center justify-between p-2 border rounded-lg text-lg'>Today <GoChevronDown /></p>
       </div>
       <div className='flex gap-3'>
          <BonusStatistic iconBgColor='green' purpose='Direct Referal bonus' />
           <BonusStatistic iconBgColor='pink' purpose='Matching bonus' />
            <BonusStatistic iconBgColor='orange' purpose='Stair Step bonus' />
             ...
             <BonusStatistic iconBgColor='green' purpose='Permote & Earn bonus' />
             </div>
        </div>
...
<div className='flex gap-6'>
       ...
       <p className='flex gap-3 items-center justify-between p-2 border rounded-lg text-lg'>Today <GoChevronDown /></p>
        ...
        <div className='flex-1 bg-white p-6 flex flex-col gap-20 rounded-md'>
          ...
          <div className='flex flex-col gap-3'>
            <NewMember memberName='Silas Dahun' userName='SilasDahun' date='20 May 2024' img={UserImg}/>
          <NewMember memberName='Silas Dahun' userName='SilasDahun' date='20 May 2024' img={UserImg}/>
          <NewMember memberName='Silas Dahun' userName='SilasDahun' date='20 May 2024' img={UserImg}/>
          <NewMember memberName='Silas Dahun' userName='SilasDahun' date='20 May 2024' img={UserImg}/>
          <NewMember memberName='Silas Dahun' userName='SilasDahun' date='20 May 2024' img={UserImg}/>
